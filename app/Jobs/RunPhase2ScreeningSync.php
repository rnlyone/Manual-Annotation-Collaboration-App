...
class RunPhase2ScreeningSync implements ShouldQueue
{
    use Queueable;
    ...
    public function handle(): void
    {
        ...
        foreach ($normalItems as $item) {
            ...
            $result  = $this->callOpenAI($apiKey, $settings->model, $prompt);
    ...
    public function failed(\Throwable $exception): void
    {
        ...
        Log::error('RunPhase2ScreeningSync failed', ['run_id' => $this->runId, 'error' => $exception->getMessage()]);
    }
