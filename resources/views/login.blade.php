...
<head>
    ...
    <title>Annotation App Login</title>


    <meta name="description" content="Start your development with a Dashboard for Bootstrap 5" />
    <meta name="keywords" content="dashboard, bootstrap 5 dashboard, bootstrap 5 design, bootstrap 5">
    <!-- Canonical SEO -->
    <link rel="canonical" href="https://1.envato.market/EDMI-ID_admin">
...
<body>
    ...
    <div class="authentication-wrapper authentication-cover">
        ...
        <a href="index.html" class="app-brand auth-cover-brand">
            ...
            <span class="app-brand-text demo text-heading fw-bold">EDMI-ID</span>
        </a>
        <!-- /Logo -->
        <div class="authentication-inner row m-0">
            ...
            <div class="d-flex col-12 col-lg-4 align-items-center authentication-bg p-sm-12 p-6">
                <div class="w-px-400 mx-auto mt-12 pt-5">
                    <h4 class="mb-1">Welcome to EDMI-ID! 👋</h4>
                    ...
                    {{-- Basic Alerts from Vuexy template --}}
                    @if ($errors->any())
